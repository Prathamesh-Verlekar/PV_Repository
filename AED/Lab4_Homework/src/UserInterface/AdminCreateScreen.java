...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(!usernamePatternCorrect()){
            ...
            JOptionPane.showMessageDialog(null,"Username should be of the form xxx_xxx@xxx.xxx","Warning",JOptionPane.WARNING_MESSAGE);  
            txtUser.setBorder(BorderFactory.createLineBorder(Color.red));
            jLabel1.setForeground(Color.red);
            return;
        }
        ...
        if(p1 == null || p1.equals("")){
            ...
            txtPword.setBorder(BorderFactory.createLineBorder(Color.red));
            jLabel2.setForeground(Color.red);
            JOptionPane.showMessageDialog(null,"Password Cant be empty","Warning",JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if(radioSupplier.isSelected()){
            ...
            JOptionPane.showConfirmDialog(null, "Supplier created successfully"); 
            toMainScreen();
        ...
        if(radioCustomer.isSelected()){
            ...
            JOptionPane.showConfirmDialog(null, "Customer created successfully");
            toMainScreen();
