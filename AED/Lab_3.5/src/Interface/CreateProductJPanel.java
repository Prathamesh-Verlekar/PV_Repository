...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (description == null || description.equals("")) {
            JOptionPane.showMessageDialog(null, "Desciption can't be empty!");
            return;
        }
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Please type in a number");
            return;
        }
        String productPrice = txtAvailablity.getText();
        try{
            Double.parseDouble(productPrice);
        }
        catch(NumberFormatException e){
            JOptionPane.showMessageDialog(null, "Please type number for price");
            return;
        }
            //Create Product
            ...
            prod.setName(name);
            prod.setAvailNum(Integer.parseInt(productAvail));
