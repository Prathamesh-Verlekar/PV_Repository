...
public class ViewPanel extends javax.swing.JPanel {
    ...
    ViewPanel(JPanel rightPanel, Product result) {
        initComponents();
        this.righPanel=rightPanel;
        this.result=result;
        txtAvailablity.setText(String.valueOf(result.getAvailNum()));
        txtPrice.setText(String.valueOf(result.getPrice()));
        txtProdName.setText(result.getName());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
           ...
           String productAvail = txtAvailablity.getText();
           try{
               Integer.parseInt(productAvail);
               } catch(NumberFormatException e) {
                   JOptionPane.showMessageDialog(null,"Please type in number of available number!");
                   return;
               }   
            ...
            result.setName(txtProdName.getText());
            result.setPrice(Double.parseDouble(txtPrice.getText()));
            result.setAvailNum(Integer.parseInt(txtAvailablity.getText()));
            result.setDescription(txtDesc.getText());
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        CardLayout layout = (CardLayout) righPanel.getLayout();
